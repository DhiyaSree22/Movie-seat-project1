...
//	Seat booking process
	...
	private void sendBookingEmail(String recipientEmail, String movieName, LocalDate date, String time, List<String> seatNumbers) {
	    String senderEmail = "santhya2699@gmail.com"; // Replace with your email address
	    String senderPassword = "zbpmbdmgtjgrbnqv" + ""; // Replace with your email password

	    // Set up mail server properties
	    System.out.println("email sending process.....");
